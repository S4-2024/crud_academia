...
INSERT INTO `cartoescredito` VALUES (1,1,'1234567812345678','João da Silva','12/2024','123','2024-06-13 20:32:09'),(2,139,'0000111122223333','user admin','12/2025','123','2024-06-15 23:14:51');
...
CREATE TABLE `clientes` (
  ...
  `pagamento` enum('PENDENTE','PAGO','ATRASADO') DEFAULT 'PENDENTE',
  PRIMARY KEY (`id`)
...
INSERT INTO `clientes` VALUES (1,'Jose Maria','123456','josemara@gmail.com','PAGO'),(2,'GABRIELLE','123456','gabrielle@gmail.com','PAGO'),(3,'martins','1232','martis@gmail.com','ATRASADO'),(4,'mario','34234','mario2@gmail.com','PENDENTE'),(5,'pedro','12433124','pedro@gmail.com','PAGO'),(6,'maria Fatima','mariazinha','fatimaM@gmail.com','ATRASADO'),(7,'Gabrielle Soares','helloworld2','so251106@gmail.com','PAGO'),(8,'Alice Carvalho','senha123','alice.carvalho@example.com','PAGO'),(9,'Bruno Almeida','senha456','bruno.almeida@example.com','ATRASADO'),(10,'Carla Silva','senha789','carla.silva@example.com','PENDENTE'),(11,'Daniel Ferreira','senha321','daniel.ferreira@example.com','PAGO'),(12,'Eduarda Costa','senha654','eduarda.costa@example.com','ATRASADO'),(13,'Felipe Souza','senha987','felipe.souza@example.com','PENDENTE'),(14,'Gabriela Lima','senha741','gabriela.lima@example.com','PAGO'),(15,'Henrique Oliveira','senha852','henrique.oliveira@example.com','ATRASADO'),(16,'Isabela Rocha','senha963','isabela.rocha@example.com','PENDENTE'),(17,'Júlio Santos','senha159','julio.santos@example.com','PAGO'),(18,'Karina Barbosa','senha753','karina.barbosa@example.com','PAGO'),(19,'Leonardo Martins','senha357','leonardo.martins@example.com','ATRASADO'),(20,'Josimar','123','Josimar@gmail.com','PENDENTE'),(21,'Nicolas Gomes','senha456','nicolas.gomes@example.com','PAGO'),(22,'Olivia Ribeiro','senha852','olivia.ribeiro@example.com','ATRASADO'),(23,'Paulo Souza','senha753','paulo.souza@example.com','PENDENTE'),(24,'Renata Almeida','senha357','renata.almeida@example.com','PAGO'),(25,'Sergio Castro','senha951','sergio.castro@example.com','ATRASADO'),(26,'Tatiana Costa','senha456','tatiana.costa@example.com','PENDENTE'),(27,'Vitor Moreira','senha852','vitor.moreira@example.com','PAGO'),(28,'gabizinha','123123','123123@123123.com','PAGO'),(133,'teste','asdas','gabrielle.sote@gmail.com','PENDENTE'),(134,'teste','asdas','gabrielle.sote@gmail.com','PENDENTE'),(135,'marcio','12345','marcio@gmail.com','PENDENTE'),(136,'marcio','12345','marcio@gmail.com','PENDENTE'),(137,'marcio','12345','marcio@gmail.com','PENDENTE'),(138,'gabrielle soares','11111','teste@teste.gmail.com','PENDENTE'),(139,'user','admin','admin@admin','PAGO');
...
--
-- Table structure for table `fichatreinamento`
--

DROP TABLE IF EXISTS `fichatreinamento`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `fichatreinamento` (
  `id` int NOT NULL AUTO_INCREMENT,
  `cliente_id` int DEFAULT NULL,
  `cliente_nome` varchar(50) DEFAULT NULL,
  `exercicio_nome` varchar(50) DEFAULT NULL,
  `exercicio_id` int DEFAULT NULL,
  `anotacao` varchar(50) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `cliente_id` (`cliente_id`),
  KEY `exercicio_id` (`exercicio_id`),
  CONSTRAINT `fichatreinamento_ibfk_1` FOREIGN KEY (`cliente_id`) REFERENCES `clientes` (`id`),
  CONSTRAINT `fichatreinamento_ibfk_2` FOREIGN KEY (`exercicio_id`) REFERENCES `exercicios` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=46 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `fichatreinamento`
--

LOCK TABLES `fichatreinamento` WRITE;
/*!40000 ALTER TABLE `fichatreinamento` DISABLE KEYS */;
INSERT INTO `fichatreinamento` VALUES (26,1,'Jose Maria','Supino Reto',1,'3x12'),(27,2,'GABRIELLE','Elevação Lateral',5,'3x15'),(28,3,'martins','Desenvolvimento com Halteres',4,'3x12'),(29,4,'mario','Puxada Alta',10,'3x12'),(30,5,'pedro','Supino Reto',1,'3x12'),(31,6,'maria Fatima','Abdominal na Máquina',13,'3x20'),(32,7,'Gabrielle Soares','Elevação Lateral',5,'3x15'),(33,8,'Alice Carvalho','Prancha',14,'3x1min'),(34,9,'Bruno Almeida','Cadeira Extensora',21,'3x15'),(35,10,'Carla Silva','Remada Baixa',11,'3x12'),(36,11,'Daniel Ferreira','Rosca Direta',16,'3x12'),(37,12,'Eduarda Costa','Remada Curvada',12,'3x15'),(38,14,'Gabriela Lima','Leg Press',20,'3x15'),(39,15,'Henrique Oliveira','Tríceps Pulley',7,'3x15'),(40,16,'Isabela Rocha','Rosca Martelo',17,'3x12'),(41,17,'Júlio Santos','Supino Reto',1,'3x12'),(42,18,'Karina Barbosa','Elevação Lateral',5,'3x15'),(43,19,'Leonardo Martins','Cadeira Flexora',22,'3x15'),(44,20,'Josimar','Abdominal na Máquina',13,'3x20'),(45,21,'Nicolas Gomes','Elevação de Quadril',25,'3x15');
/*!40000 ALTER TABLE `fichatreinamento` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Temporary view structure for view `fichatreinamento_completa`
--

DROP TABLE IF EXISTS `fichatreinamento_completa`;
/*!50001 DROP VIEW IF EXISTS `fichatreinamento_completa`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `fichatreinamento_completa` AS SELECT 
 1 AS `id`,
 1 AS `cliente_nome`,
 1 AS `exercicio_nome`,
 1 AS `anotacao`*/;
...
INSERT INTO `funcionarios` VALUES (1,'Rosimar','124.567.897-12','123456789','rosimar@gmail.com'),(2,'Maria','233.434.233-12','mariazinha123','maria@gmail.com'),(3,'Jose','152.741.816-35','jose123','jose@gmail.com'),(4,'João Silva','12345678901','senha123','joao.silva@example.com'),(5,'Maria Oliveira','23456789012','senha456','maria.oliveira@example.com'),(6,'Carlos Pereira','34567890123','senha789','carlos.pereira@example.com'),(7,'Ana Souza','45678901234','senha321','ana.souza@example.com'),(8,'Fernanda Lima','56789012345','senha654','fernanda.lima@example.com'),(9,'Pedro Santos','67890123456','senha987','pedro.santos@example.com'),(10,'Lucas Costa','78901234567','senha741','lucas.costa@example.com'),(11,'Juliana Martins','44556677889','senha456','juliana.martins@example.com'),(12,'Gabriel Lima','55667788990','senha852','gabriel.lima@example.com'),(13,'Roberto Carlos','123.345.356-67','rob@gmail.com','12356'),(14,'Roberto Carlos','123.345.356-67','rob@gmail.com','12356'),(15,'Roberto Carlos','123.345.356-67','rob@gmail.com','12356'),(16,'Roberto Carlos','123.345.356-67','rob@gmail.com','12356'),(18,'gabrielle soares','152.791.816-50','admin','so251106@gmail.com'),(19,'Roberto Carlos','123.345.356-67','rob@gmail.com','12356'),(20,'Admin','111.111.111-11','admin','admin@admin');
...
--
-- Final view structure for view `fichatreinamento_completa`
--
...
/*!50001 VIEW `fichatreinamento_completa` AS select `ft`.`id` AS `id`,`c`.`nome` AS `cliente_nome`,`e`.`nome` AS `exercicio_nome`,`ft`.`anotacao` AS `anotacao` from ((`fichatreinamento` `ft` join `clientes` `c` on((`ft`.`cliente_id` = `c`.`id`))) join `exercicios` `e` on((`ft`.`exercicio_id` = `e`.`id`))) */;
...
-- Dump completed on 2024-06-17 16:56:24
